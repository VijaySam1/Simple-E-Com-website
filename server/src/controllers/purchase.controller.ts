...
export class PurchaseController {
  ...
  async create(
    ...
    purchases: Omit<Purchase, 'id'>,
  ): Promise<Purchase> {
    let {purchaseNo, ...purchase} = purchases;
    purchaseNo = (await (await this.purchaseRepository.count()).count) + 10000;
    return this.purchaseRepository.create({purchaseNo, ...purchase});
  }
